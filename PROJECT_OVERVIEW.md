...
- **Main Script** (`scripts/generate_summaries.py`) - Standalone tool to process books and generate summaries (1700+ lines)
- **Advanced Features:**
...
# With metadata
python scripts/generate_summaries.py book.txt --title "Title" --author "Author"
...
python scripts/generate_summaries.py book.txt --dry-run

# Partial run (concise + medium + first 3 chapters only)
python scripts/generate_summaries.py book.txt --partial-run
```

### Chapter Regeneration
```bash
# Regenerate specific chapters
python scripts/generate_summaries.py book.txt --regenerate-chapters "12,13,15"

# Regenerate with bulk mode (processes in batches)
python scripts/generate_summaries.py book.txt --regenerate-chapters "1,2,3,4,5"
```
...
3. **Generate Summaries:**
   ...
   # Regenerate specific chapters
   python scripts/generate_summaries.py data/books/book.txt --regenerate-chapters "12,13"
   ```
...
python scripts/generate_summaries.py book.txt --regenerate-chapters "1,2,3"
```
