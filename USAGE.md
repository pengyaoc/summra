...
**For a single book:**
```bash
python scripts/generate_summaries.py data/books/pride_and_prejudice.txt
```
...
# 4. Generate summaries
python scripts/generate_summaries.py data/books/alice.txt \
...
python scripts/generate_summaries.py data/books/book1.txt
# Wait a few minutes
python scripts/generate_summaries.py data/books/book2.txt
```
