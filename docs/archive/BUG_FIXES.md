...
**File:** `scripts/content/generate_summaries.py` (lines 397-432)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 1095-1128)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 893-902)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 627-635)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 683-694)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 400-402, 474-488, 500-505, 1199-1201)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 725-772, 1272-1320)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 521-546, 688-724, 725-755)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py:4547`
...
**File:** `scripts/content/generate_summaries.py` (lines 951-960)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 951-961, 1245-1247)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 2044-2046, 2066-2071, 2081-2082, 548-558, 571-602)
**Status:** ✅ FIXED
...
**File:** `scripts/content/generate_summaries.py` (lines 802-831, 1436-1461)
**Status:** ⚠️ POSTPONED
...
**File:** `scripts/content/generate_summaries.py` (lines 302-310)
**Status:** ✅ FIXED
...
**scripts/content/generate_summaries.py (lines 302-310)**
...
**File:** `scripts/content/generate_summaries.py` (lines 426-428)
**Status:** ✅ FIXED
...
**scripts/content/generate_summaries.py (lines 426-428)**
...
**File:** `scripts/content/generate_summaries.py` (lines 892, 1157-1161, 3559-3566, 4540-4541)
**Status:** ✅ FIXED
...
1. **scripts/content/generate_summaries.py (line 892)** - Added PRELUDE to preface patterns
2. **scripts/content/generate_summaries.py (line 1107)** - Use preface_marker in new architecture
3. **scripts/content/generate_summaries.py (lines 1157-1161)** - Don't skip short chapters
4. **scripts/content/generate_summaries.py (lines 3559-3566)** - Detect TOC metadata for two-level structures
5. **scripts/content/generate_summaries.py (lines 4540-4541)** - Use preface_marker in legacy path
...
**File:** `scripts/content/generate_summaries.py` (line 206)
**Status:** ✅ FIXED
...
**scripts/content/generate_summaries.py (line 206)** - Lowered MIN_CHAPTER_CHARS from 100 to 20
