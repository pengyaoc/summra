...
Usage:
    python scripts/update_book_cover.py --book-id 38 --source /path/to/cover.png
    python scripts/update_book_cover.py --title "A Christmas Carol" --source /path/to/cover.png
    python scripts/update_book_cover.py --list  # List all books
"""
...
Examples:
  # List all books
  python scripts/update_book_cover.py --list
  ...
  python scripts/update_book_cover.py --book-id 38 --source /path/to/cover.png --output custom_cover.png
        """
    )
