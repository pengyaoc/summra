...
Usage:
    python scripts/audio/batch_generate_concise_audio.py
    python scripts/audio/batch_generate_concise_audio.py --dry-run
"""
...
def main():
    ...
    print("  python scripts/audio/generate_gemini_audio_batch_offline.py --summary-type concise")
    print("="*80)
    print()
    print("="*80)
