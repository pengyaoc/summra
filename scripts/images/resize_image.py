...
Usage:
    Single file mode:
        python scripts/images/resize_image.py input.png output.png
        python scripts/images/resize_image.py input.png  # outputs to input_resized.png

    Bulk mode:
        python scripts/images/resize_image.py --bulk file1.png file2.png file3.png
        python scripts/images/resize_image.py --bulk *.png
        python scripts/images/resize_image.py --bulk --target 0.5 *.png  # Target 0.5MB

    Hero image mode (reduce height by 1/3, convert to JPG/WebP):
        python scripts/images/resize_image.py --hero-img input.png [output_dir] [max_width]
        python scripts/images/resize_image.py --hero-img data/img/library_view.png frontend/static/images 1920
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("    python scripts/images/resize_image.py input.png [output.png] [target_mb]")
        print("  Bulk mode:")
        print("    python scripts/images/resize_image.py --bulk [--target MB] [--output-dir DIR] file1.png file2.png ...")
        print("  Hero image mode:")
        print("    python scripts/images/resize_image.py --hero-img input.png [output_dir] [max_width]")
        print("\nExamples:")
        print("  python scripts/images/resize_image.py input.png output.png")
        print("  python scripts/images/resize_image.py input.png output.png 0.5  # Target 0.5MB")
        print("  python scripts/images/resize_image.py input.png  # Output to input_resized.png")
        print("  python scripts/images/resize_image.py --bulk *.png")
        print("  python scripts/images/resize_image.py --bulk --target 0.5 file1.png file2.png")
        print("  python scripts/images/resize_image.py --bulk --output-dir resized/ *.png")
        print("  python scripts/images/resize_image.py --hero-img data/img/library_view.png frontend/static/images")
        sys.exit(1)
    ...
    if sys.argv[1] == '--hero-img':
        if len(sys.argv) < 3:
            ...
            print("Usage: python scripts/images/resize_image.py --hero-img input.png [output_dir] [max_width]")
            sys.exit(1)
