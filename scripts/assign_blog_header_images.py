...
Usage:
    python scripts/assign_blog_header_images.py             # Assign to all posts missing images
    python scripts/assign_blog_header_images.py --slug SLUG # Assign to specific post
    python scripts/assign_blog_header_images.py --force     # Re-assign to all posts
"""
