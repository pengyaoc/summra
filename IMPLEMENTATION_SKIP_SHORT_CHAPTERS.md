...
### 1. Backend: scripts/generate_summaries.py
...
```bash
source venv/bin/activate && python scripts/generate_summaries.py /tmp/pg16.txt --title "Peter Pan" --author "J. M. Barrie" --dry-run
```
